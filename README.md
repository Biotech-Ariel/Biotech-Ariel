...
**ESPAÑOL**
<p align="center">
__Científico de Datos__ con amplia experiencia en análisis de datos, modelado estadístico y desarrollo de soluciones predictivas. Uso de lenguajes de programación como **Python** y **R**, así como en herramientas de análisis de datos como **TensorFlow** y **scikit-learn**. Capaz de transformar datos complejos en información accionable y tomar decisiones fundamentadas para impulsar estrategias empresariales. Mi enfoque combina habilidades técnicas sólidas con una mente analítica y creativa para abordar desafíos en el mundo de la ciencia de datos. </p>
...
*   🌍  I'm based in México
*   🖥️  See my portfolio at [DS_Projects](https://github.com/Biotech-Ariel?tab=repositories)
*   ✉️  You can contact me at [a.mendozalab@gmail.com](mailto:a.mendozalab@gmail.com)
*   🧠  Keep learning and focused on Machine Learning and LLMs. 
...
<a href = "https://medium.com/@a.mendoza_BioDS">
  <img src = "https://img.shields.io/badge/Medium-12100E?style=for-the-badge&logo=medium&logoColor=white"
    </a>
<a href = "https://www.kaggle.com/arielsebastian">
